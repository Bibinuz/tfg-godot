...
%\babelfont{rm}{FreeSerif} % Or any system font
...
\blfootnote{$\bullet$ Menció: Enginyeria de Computadors / Computació / Enginyeria del Software / Tecnologies de la Informació}
